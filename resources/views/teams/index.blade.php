    ...
    <div class="col-md-8 col-md-offset-2">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <ul>
                    <li><i class="fa fa-file-text-o"></i> All the current Teams</li>
                    <a href="#" class="add-modal"><li>Add a Team</li></a>
                </ul>
            </div>
                        ...
                        <tbody>
                            @foreach($teams as $indexKey => $team)
                                <tr class="item{{$team->id}} @if($team->is_published) warning @endif">
                                    ...
                                    <td>
                                        <button class="show-modal btn btn-success" data-id="{{$team->id}}" data-name="{{$team->name}}">
                                        <span class="glyphicon glyphicon-eye-open"></span> Show</button>
                                        <button class="edit-modal btn btn-info" data-id="{{$team->id}}" data-name="{{$team->name}}">
